...
urlpatterns = [
    ...
    path('operations/configure-visa/<int:booking_id>/', views.configure_visa_form, name='admin_configure_visa'),
    
    # Invoice PDF generation
    path('invoice/<int:booking_id>/', views.invoice_pdf, name='invoice_pdf'),
    
    # Airport Autocomplete (Required for FlightTicket Inline)
    path('api/airport-autocomplete/', views.airport_autocomplete, name='airport_autocomplete'),
